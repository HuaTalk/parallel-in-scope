 ...
 * signatures cannot express lifecycle rejection. It may be raised either by a blocked operation
 * that was released by lifecycle shutdown or by a new operation rejected after admission closed.
 * {@link ClosableBlockingQueue} uses Monitor guards to release blocked callers and does not
 * interrupt threads.
 *

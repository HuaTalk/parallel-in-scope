 ...
 * This prevents independent wrappers or value-like executors from being merged as one resource.
 * The textual form is diagnostics only and must not be persisted or used as a graph key.
 */

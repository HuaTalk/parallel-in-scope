 ...
 * inner callables to access the current batch cancellation and diagnostics context.
...
public class ScopedCallable<V> implements Callable<V> {
    ...
    public ScopedCallable(String taskName, Callable<V> delegate, BatchExecutionContext batchContext,
        ...
        this.newTaskListeners = taskListeners == null
                ? java.util.Collections.emptyList() : taskListeners;

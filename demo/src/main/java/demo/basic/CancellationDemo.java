 ...
 *   <li>配置 {@link ParOptions} 超时时间触发取消
...
public class CancellationDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ParConfig config = ParConfig.builder().executor("cancel-demo", pool).build();
    ...
    try {
      ...
      // 1. 配置并行选项（设置超时）
      ParOptions options = ParOptions.of("cancel-demo").parallelism(3).timeout(2000).build();
